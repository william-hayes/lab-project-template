...
**Notebooks for interactive tasks like running stats and generating plots.**

*Example:* R Markdown that reads in the master data, performs an ANOVA, and generates a bar graph.
